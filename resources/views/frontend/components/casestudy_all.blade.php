                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="post_card1">
                            ...
                            <div class="card_image">
                                <img src="{{asset($case->cover_image ?? 'https://images.unsplash.com/photo-1559028012-481c04fa702d?q=80&w=800&auto=format&fit=crop')}}" alt="{{ $case->title ?? 'post image' }}">

                                <div class="overlay"></div>

                                <span class="category">{{$case->type ?? ''}}</span>
                            </div>

                            <div class="card_content">
                                <h4 class="card_title"> {{ $case->title ?? '' }}</h4>
