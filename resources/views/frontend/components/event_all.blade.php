                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="post_card1">
                            ...
                            <div class="card_image">
                                <img src="{{asset($event->cover_image ?? 'https://images.unsplash.com/photo-1559028012-481c04fa702d?q=80&w=800&auto=format&fit=crop')}}" alt="{{ $event->title ?? 'post image' }}">
                            ...
                            <div class="card_content">
                                <h4 class="card_title"> {{ $event->title ?? '' }}</h4>
                                ...
                                <div class="card_footer">
                                    <span class="date">{{ $event->created_at->format('M,d,Y') }}</span>
                                    <a href="{{ route('details.event',[$event->id,$event->url]) }}" class="read_more">{{ $event->button ?? 'Read more ' }} →</a>
                                </div>
                            </div>
