...
const form = useForm('user_contact_messages', {
...
const handleSubmit = () => {
  form.post(route('user_contact_messages.submit'), {
          ...
          <div class="flex flex-wrap justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
           ...
           <div>
             <button
              ...
              <Link :href="route('user_contact_messages.all')">All Information</Link>
            </button>
              ...
              <input type="hidden" name="section_id" id="section_id" v-model="form.section_id"/>
                <div class="grid grid-cols-12 gap-4">
                  <div class="col-span-12 md:col-span-6">
                   <div class="mb-4">
                    <label for="Media" class="block text-sm font-medium text-slate-700 mb-1" >Select Media Type</label>

                    <select id="category" v-model="form.type" required class="block w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm text-slate-700 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:outline-none transition-colors duration-200">
                     
                      <option value=""> Select Meida Type </option>
                  ...
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      ...
                      <input type="text" placeholder="Sub Heading" v-model="form.title"
