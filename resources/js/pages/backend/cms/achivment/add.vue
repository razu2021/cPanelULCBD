...
const form = useForm('achivement_manage', {
...
const handleSubmit = () => {
  form.post(route('achivement_manage.submit'), {
              ...
              <!-- icon import  -->
                ...
                <div class="grid grid-cols-12 gap-4">
                  <div class="col-span-12 md:col-span-12">
                    <div>
                      <label class="text-sm font-medium text-slate-600">Total Achivment </label>
                      <input type="number" placeholder="50" v-model="form.count"
                        ...
                        <div class="text-small text-red-500" v-if="form.errors.count">{{ form.errors.count }}</div>
                    </div>
                  </div>
                  <!-- col end -->
