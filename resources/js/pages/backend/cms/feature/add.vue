...
const form = useForm('sectionfeature_manage', {
  featureable_id:  props.target_id,
  featureable_type:  props.target_model,
  icon: '',
  title: '',
  short_des: '',
  order: '',
...
const handleSubmit = () => {
  form.post(route('sectionfeature_manage.submit'), {
          ...
          <div class="flex flex-wrap justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
           ...
           <div>
             <button
              ...
              <Link :href="route('sectionfeature_manage.all')">All Information</Link>
            </button>
        ...
        <div class="col-span-12 lg:col-span-8">
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
            ...
            <div class="border-b pb-4">
              ...
              <input type="hidden" name="featureable_id" id="featureable_id" v-model="form.featureable_id"/>
              <input type="hidden" name="featureable_type" id="featureable_type" v-model="form.featureable_type"/>
                ...
                <div class="grid grid-cols-12 gap-4">
                  ...
                  <div class="col-span-12 md:col-span-12">
                    <div>
                      ...
                      <input type="text" placeholder="Title" v-model="form.short_des"
                        class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500">
