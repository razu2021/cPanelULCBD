...
const form = useForm('clients_manage', {
...
const handleSubmit = () => {
  form.post(route('clients_manage.submit'), {
              ...
              <input type="hidden" name="section_id" id="section_id" v-model="form.section_id"/>
                <div class="grid grid-cols-12 gap-4">
                  ...
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      <label class="text-sm font-medium text-slate-600">Clint Name</label>
                      <input type="text" placeholder="Client Name" v-model="form.name"
                        class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500">
                  ...
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      <label class="text-sm font-medium text-slate-600">Clients Email</label>
                ...
                <div class="grid grid-cols-12 gap-4">
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      <label class="text-sm font-medium text-slate-600">Client Phone</label>
                  ...
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      <label class="text-sm font-medium text-slate-600">Client Address</label>
                ...
                <div class="grid grid-cols-12 gap-4">
                  ...
                  <div class="col-span-12 md:col-span-12">
                    <div>
                      ...
                      <input type="text" placeholder="Sub Title" v-model="form.case_title"
                        class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500">
