...
const form = useForm('countrydestination_manage', {
...
const handleSubmit = () => {
  form.post(route('countrydestination_manage.submit'), {
          ...
          <div class="flex flex-wrap justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
           ...
           <div>
             <button
              ...
              <Link :href="route('countrydestination_manage.all')">All Information</Link>
            </button>
