...
const form = useForm('contact_email', {
  type: '',
  email: '',
  title: '',
  description: '',
  ...
  const handleSubmit = () => {
    form.post(route('contact_email.submit'), {
      onSuccess: () => {
        form.reset()
      },
    })
        ...
        <div class="col-span-12">
          <div class="flex items-center justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
            ...
            <button
              ...
              <Link :href="route('contact_email.all')">All Information</Link>
            </button>
          </div>
        </div>
          ...
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
            ...
            <div class="border-b pb-4">
              ...
              <div>
                ...
                <input type="email" placeholder="Enter Email Address" v-model="form.email" required
                ...
                <!-- end -->
              <div>
                <label class="text-sm font-medium text-slate-600">Email Title </label>
              ...
              <div>
                <label class="text-sm font-medium text-slate-600">Email Description</label>
                <textarea
                  rows="5"
