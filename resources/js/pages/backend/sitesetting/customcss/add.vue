...
const form = useForm('custom_css', {
  ...
  const handleSubmit = () => {
    form.post(route('custom_css.submit'), {
      onSuccess: () => {
        form.reset()
      },
    })
          ...
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
            ...
            <div class="border-b pb-4">
              ...
              <div>
                ...
                <input type="text" required placeholder="Enter Note : " v-model="form.css_note"
              ...
              <div>
                <label class="text-sm font-medium text-slate-600"> Custome CSS </label>
                <textarea
                  rows="5"
                  placeholder="Write Custom CSS..." v-model="form.custom_css"
