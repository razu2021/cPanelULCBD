...
const handleUpdate = () => {
  form.patch(route('faveicon.update'))
...
<div class="container  mx-auto my-10 px-4">
  ...
  <div class="grid grid-cols-12 gap-8">
            ...
            <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
                ...
                <div>
                    <label class="text-sm font-medium text-slate-600"> Update Icon</label>
                    <input type="text" placeholder="Enter title" v-model="form.icons"
