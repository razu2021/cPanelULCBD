...
const form  = useForm(
  {
    ...
    script_note: props.data.script_note,
    custom_script: props.data.custom_script,
...
const handleUpdate = () => {
  form.patch(route('custom_script.update'))
  ...
  <div class="grid grid-cols-12 gap-8">
            ...
            <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Enter title" v-model="form.script_note"
                ...
                <div>
                    ...
                    <textarea
                    rows="5"
                    placeholder="Write something meaningful..." v-model="form.custom_script"
