...
const form = useForm('contact_address', {
  type: '',
  address: '',
  title: '',
  description: '',
  ...
  const handleSubmit = () => {
    form.post(route('contact_address.submit'), {
      onSuccess: () => {
        form.reset()
      },
    })
        ...
        <div class="col-span-12">
          <div class="flex items-center justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
            ...
            <button
              ...
              <Link :href="route('contact_address.all')">All Information</Link>
            </button>
          </div>
        </div>
          ...
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
            ...
            <div class="border-b pb-4">
              ...
              <div>
                ...
                <input type="text" placeholder="Write here !" v-model="form.address" required
