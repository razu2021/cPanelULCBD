...
const handleSubmit = () => {
  form.post(route('site_info.submit'), {
          ...
          <div class="flex flex-wrap justify-between rounded-2xl bg-black py-4 px-5 text-white shadow-lg">
           ...
           <div>
             <button
              ...
              <Link :href="route('site_info.all')">All Information</Link>
            </button>
        ...
        <div class="col-span-12 lg:col-span-8">
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
            ...
            <div class="border-b pb-4">
              ...
              <!-- end -->
              <div>
                <label class="text-sm font-medium text-slate-600 mx-2">Site Name</label>
                <input type="text"  v-model="form.site_name"
                  ...
                  <div class="text-small text-red-500" v-if="form.errors.site_name">{{ form.errors.site_name }}</div>
              </div>
              <!-- end -->
              <div>
                <label class="text-sm font-medium text-slate-600 mx-2">Site Title</label>
                <input type="text"  v-model="form.site_title"
                  class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500">
                  <div class="text-small text-red-500" v-if="form.errors.site_title">{{ form.errors.site_title }}</div>
              </div>
              <!-- end -->
              <div>
                <label class="text-sm font-medium text-slate-600 mx-2">Site Slogan</label>
                <input type="text"  v-model="form.site_slogan"
                  class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500">
                  <div class="text-small text-red-500" v-if="form.errors.site_slogan">{{ form.errors.site_slogan }}</div>
              </div>
              <!-- end -->
        ...
        <div class="col-span-12 lg:col-span-4">
          <div class="space-y-6">
            ...
            <div class="rounded-2xl bg-white p-5 shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
                <h3 class="text-sm font-semibold text-slate-800 mb-4">Upload Logo</h3>
            ...
            <!-- Thumbnail upload-->
            <div class="rounded-2xl bg-white p-5 shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
                <h3 class="text-sm font-semibold text-slate-800 mb-4">Upload Faveicon</h3>
                <label class="flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-4 py-6 cursor-pointer hover:bg-slate-100 transition">
