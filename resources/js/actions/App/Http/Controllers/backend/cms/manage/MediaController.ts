...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::index
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:27
 * @route '/admin/dashboad/manage/section/media/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::add
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:52
 * @route '/admin/dashboad/manage/section/media/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::view
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:63
 * @route '/admin/dashboad/manage/section/media/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::edit
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:75
 * @route '/admin/dashboad/manage/section/media/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::insert
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:92
 * @route '/admin/dashboad/manage/section/media/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/media/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::update
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:159
 * @route '/admin/dashboad/manage/section/media/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/media/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::active
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:223
 * @route '/admin/dashboad/manage/section/media/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::deactive
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:238
 * @route '/admin/dashboad/manage/section/media/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:253
 * @route '/admin/dashboad/manage/section/media/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/media/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:268
 * @route '/admin/dashboad/manage/section/media/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/media/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::recycle
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:297
 * @route '/admin/dashboad/manage/section/media/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:331
 * @route '/admin/dashboad/manage/section/media/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/media/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:436
 * @route '/admin/dashboad/manage/section/media/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:465
 * @route '/admin/dashboad/manage/section/media/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:472
 * @route '/admin/dashboad/manage/section/media/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\MediaController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/MediaController.php:450
 * @route '/admin/dashboad/manage/section/media/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/media/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const MediaController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
