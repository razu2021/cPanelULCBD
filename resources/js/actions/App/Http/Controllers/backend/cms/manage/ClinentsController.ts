...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::index
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:27
 * @route '/admin/dashboad/manage/section/clients/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::add
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:52
 * @route '/admin/dashboad/manage/section/clients/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::view
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:63
 * @route '/admin/dashboad/manage/section/clients/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::edit
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:75
 * @route '/admin/dashboad/manage/section/clients/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::insert
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:92
 * @route '/admin/dashboad/manage/section/clients/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/clients/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::update
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:180
 * @route '/admin/dashboad/manage/section/clients/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/clients/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::active
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:273
 * @route '/admin/dashboad/manage/section/clients/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::deactive
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:289
 * @route '/admin/dashboad/manage/section/clients/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:305
 * @route '/admin/dashboad/manage/section/clients/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/clients/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:320
 * @route '/admin/dashboad/manage/section/clients/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/clients/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::recycle
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:349
 * @route '/admin/dashboad/manage/section/clients/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:383
 * @route '/admin/dashboad/manage/section/clients/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/clients/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:488
 * @route '/admin/dashboad/manage/section/clients/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:517
 * @route '/admin/dashboad/manage/section/clients/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:524
 * @route '/admin/dashboad/manage/section/clients/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ClinentsController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/ClinentsController.php:502
 * @route '/admin/dashboad/manage/section/clients/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/clients/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const ClinentsController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }

export default ClinentsController