...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::index
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:23
 * @route '/admin/dashboad/category/category-page/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/all',
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::add
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:48
 * @route '/admin/dashboad/category/category-page/add'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/add',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::view
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:57
 * @route '/admin/dashboad/category/category-page/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::edit
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:69
 * @route '/admin/dashboad/category/category-page/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::insert
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:86
 * @route '/admin/dashboad/category/category-page/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/category/category-page/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::update
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:158
 * @route '/admin/dashboad/category/category-page/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/category/category-page/update',
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::active
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:216
 * @route '/admin/dashboad/category/category-page/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::deactive
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:232
 * @route '/admin/dashboad/category/category-page/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::softdelete
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:248
 * @route '/admin/dashboad/category/category-page/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/category/category-page/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::deleteMethod
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:262
 * @route '/admin/dashboad/category/category-page/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/category/category-page/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::recycle
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:278
 * @route '/admin/dashboad/category/category-page/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::bulkAction
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:312
 * @route '/admin/dashboad/category/category-page/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/category/category-page/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::exportPdf
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:407
 * @route '/admin/dashboad/category/category-page/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::export_excel
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:436
 * @route '/admin/dashboad/category/category-page/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::export_csv
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:443
 * @route '/admin/dashboad/category/category-page/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\CategoryPageController::export_pdf
 * @see app/Http/Controllers/backend/cms/CategoryPageController.php:421
 * @route '/admin/dashboad/category/category-page/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/category/category-page/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const CategoryPageController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
