...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::index
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:27
 * @route '/admin/dashboad/manage/section/reaserch/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::add
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:52
 * @route '/admin/dashboad/manage/section/reaserch/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::view
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:63
 * @route '/admin/dashboad/manage/section/reaserch/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::edit
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:75
 * @route '/admin/dashboad/manage/section/reaserch/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::insert
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:92
 * @route '/admin/dashboad/manage/section/reaserch/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/reaserch/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::update
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:176
 * @route '/admin/dashboad/manage/section/reaserch/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/reaserch/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::active
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:265
 * @route '/admin/dashboad/manage/section/reaserch/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::deactive
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:281
 * @route '/admin/dashboad/manage/section/reaserch/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:297
 * @route '/admin/dashboad/manage/section/reaserch/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/reaserch/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:312
 * @route '/admin/dashboad/manage/section/reaserch/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/reaserch/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::recycle
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:341
 * @route '/admin/dashboad/manage/section/reaserch/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:375
 * @route '/admin/dashboad/manage/section/reaserch/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/reaserch/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:480
 * @route '/admin/dashboad/manage/section/reaserch/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:509
 * @route '/admin/dashboad/manage/section/reaserch/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:516
 * @route '/admin/dashboad/manage/section/reaserch/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ReaserchController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/ReaserchController.php:494
 * @route '/admin/dashboad/manage/section/reaserch/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/reaserch/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const ReaserchController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }

export default ReaserchController