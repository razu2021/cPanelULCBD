...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::index
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:27
 * @route '/admin/dashboad/manage/section/faq/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::add
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:52
 * @route '/admin/dashboad/manage/section/faq/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::view
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:66
 * @route '/admin/dashboad/manage/section/faq/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::edit
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:79
 * @route '/admin/dashboad/manage/section/faq/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::insert
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:98
 * @route '/admin/dashboad/manage/section/faq/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/faq/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::update
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:151
 * @route '/admin/dashboad/manage/section/faq/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/faq/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::active
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:203
 * @route '/admin/dashboad/manage/section/faq/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::deactive
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:219
 * @route '/admin/dashboad/manage/section/faq/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:235
 * @route '/admin/dashboad/manage/section/faq/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/faq/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:250
 * @route '/admin/dashboad/manage/section/faq/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/faq/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::recycle
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:279
 * @route '/admin/dashboad/manage/section/faq/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:313
 * @route '/admin/dashboad/manage/section/faq/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/faq/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:418
 * @route '/admin/dashboad/manage/section/faq/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:447
 * @route '/admin/dashboad/manage/section/faq/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:454
 * @route '/admin/dashboad/manage/section/faq/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\FaqController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/FaqController.php:432
 * @route '/admin/dashboad/manage/section/faq/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/faq/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const FaqController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
