...
/**
* @see \App\Http\Controllers\backend\cms\manage\ImagegalleryController::index
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\ImagegalleryController::insert
...
/**
* @see \App\Http\Controllers\backend\cms\manage\ImagegalleryController::exportPdf
...
const ImagegalleryController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
