...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::index
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:26
 * @route '/admin/dashboad/manage/section/news/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::add
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:51
 * @route '/admin/dashboad/manage/section/news/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::view
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:62
 * @route '/admin/dashboad/manage/section/news/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::edit
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:74
 * @route '/admin/dashboad/manage/section/news/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::insert
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:91
 * @route '/admin/dashboad/manage/section/news/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/news/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::update
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:174
 * @route '/admin/dashboad/manage/section/news/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/news/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::active
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:257
 * @route '/admin/dashboad/manage/section/news/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::deactive
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:273
 * @route '/admin/dashboad/manage/section/news/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:289
 * @route '/admin/dashboad/manage/section/news/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/news/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:304
 * @route '/admin/dashboad/manage/section/news/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/news/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::recycle
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:333
 * @route '/admin/dashboad/manage/section/news/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:367
 * @route '/admin/dashboad/manage/section/news/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/news/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:472
 * @route '/admin/dashboad/manage/section/news/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:501
 * @route '/admin/dashboad/manage/section/news/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:508
 * @route '/admin/dashboad/manage/section/news/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\NewsController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/NewsController.php:486
 * @route '/admin/dashboad/manage/section/news/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/news/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const NewsController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
