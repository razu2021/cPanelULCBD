...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::index
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:27
 * @route '/admin/dashboad/manage/section/about/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::add
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:52
 * @route '/admin/dashboad/manage/section/about/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::view
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:66
 * @route '/admin/dashboad/manage/section/about/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::edit
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:79
 * @route '/admin/dashboad/manage/section/about/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::insert
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:98
 * @route '/admin/dashboad/manage/section/about/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/about/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::update
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:182
 * @route '/admin/dashboad/manage/section/about/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/about/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::active
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:267
 * @route '/admin/dashboad/manage/section/about/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::deactive
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:283
 * @route '/admin/dashboad/manage/section/about/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:299
 * @route '/admin/dashboad/manage/section/about/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/about/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:314
 * @route '/admin/dashboad/manage/section/about/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/about/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::recycle
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:343
 * @route '/admin/dashboad/manage/section/about/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:377
 * @route '/admin/dashboad/manage/section/about/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/about/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:482
 * @route '/admin/dashboad/manage/section/about/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:511
 * @route '/admin/dashboad/manage/section/about/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:518
 * @route '/admin/dashboad/manage/section/about/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\AboutController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/AboutController.php:496
 * @route '/admin/dashboad/manage/section/about/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/about/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const AboutController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
