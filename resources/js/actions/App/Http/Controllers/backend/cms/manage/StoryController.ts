...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::index
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:27
 * @route '/admin/dashboad/manage/section/stories/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::add
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:52
 * @route '/admin/dashboad/manage/section/stories/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::view
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:63
 * @route '/admin/dashboad/manage/section/stories/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::edit
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:75
 * @route '/admin/dashboad/manage/section/stories/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::insert
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:92
 * @route '/admin/dashboad/manage/section/stories/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/stories/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::update
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:173
 * @route '/admin/dashboad/manage/section/stories/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/stories/update',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::active
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:259
 * @route '/admin/dashboad/manage/section/stories/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::deactive
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:275
 * @route '/admin/dashboad/manage/section/stories/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::softdelete
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:291
 * @route '/admin/dashboad/manage/section/stories/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/stories/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::deleteMethod
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:306
 * @route '/admin/dashboad/manage/section/stories/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/stories/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::recycle
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:335
 * @route '/admin/dashboad/manage/section/stories/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::bulkAction
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:369
 * @route '/admin/dashboad/manage/section/stories/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/stories/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::exportPdf
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:474
 * @route '/admin/dashboad/manage/section/stories/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::export_excel
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:503
 * @route '/admin/dashboad/manage/section/stories/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::export_csv
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:510
 * @route '/admin/dashboad/manage/section/stories/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\cms\manage\StoryController::export_pdf
 * @see app/Http/Controllers/backend/cms/manage/StoryController.php:488
 * @route '/admin/dashboad/manage/section/stories/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/stories/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const StoryController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
