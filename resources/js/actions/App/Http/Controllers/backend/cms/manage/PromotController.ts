...
/**
* @see \App\Http\Controllers\backend\cms\manage\PromotController::index
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\PromotController::insert
...
/**
* @see \App\Http\Controllers\backend\cms\manage\PromotController::exportPdf
...
const PromotController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }

export default PromotController