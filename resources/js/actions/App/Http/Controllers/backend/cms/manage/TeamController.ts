...
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::index
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:27
 * @route '/admin/dashboad/manage/section/team/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/all',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::add
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:52
 * @route '/admin/dashboad/manage/section/team/add/{id}/{slug}'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/add/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::view
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:66
 * @route '/admin/dashboad/manage/section/team/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::edit
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:78
 * @route '/admin/dashboad/manage/section/team/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::insert
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:98
 * @route '/admin/dashboad/manage/section/team/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/team/submit',
...
/**
* @see \App\Http\Controllers\backend\cms\manage\TeamController::update
 * @see app/Http/Controllers/backend/cms/manage/TeamController.php:180
 * @route '/admin/dashboad/manage/section/team/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/section/team/update',
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/team/softdelete/{id}',
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/section/team/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/recycle',
} satisfies RouteDefinition<["get","head"]>
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/section/team/bulk/action',
} satisfies RouteDefinition<["post"]>
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/section/team/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const TeamController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
