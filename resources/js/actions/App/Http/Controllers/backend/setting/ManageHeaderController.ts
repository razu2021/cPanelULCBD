...
/**
* @see \App\Http\Controllers\backend\setting\ManageHeaderController::index
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\setting\ManageHeaderController::insert
...
/**
* @see \App\Http\Controllers\backend\setting\ManageHeaderController::exportPdf
...
/**
* @see \App\Http\Controllers\backend\setting\ManageHeaderController::ThemeChoose
...
/**
* @see \App\Http\Controllers\backend\setting\ManageHeaderController::themeUpdate
...
const ManageHeaderController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, ThemeChoose, themeUpdate, delete: deleteMethod }

export default ManageHeaderController