...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::index
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:24
 * @route '/admin/dashboad/manage/setting/preloader/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/all',
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::add
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:49
 * @route '/admin/dashboad/manage/setting/preloader/add'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/add',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::view
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:60
 * @route '/admin/dashboad/manage/setting/preloader/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::edit
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:72
 * @route '/admin/dashboad/manage/setting/preloader/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::insert
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:87
 * @route '/admin/dashboad/manage/setting/preloader/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/setting/preloader/submit',
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::update
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:140
 * @route '/admin/dashboad/manage/setting/preloader/update'
 */
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/setting/preloader/update',
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::active
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:196
 * @route '/admin/dashboad/manage/setting/preloader/active/{id}/{slug}'
 */
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::deactive
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:215
 * @route '/admin/dashboad/manage/setting/preloader/deactive/{id}/{slug}'
 */
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::softdelete
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:234
 * @route '/admin/dashboad/manage/setting/preloader/softdelete/{id}'
 */
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/setting/preloader/softdelete/{id}',
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::deleteMethod
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:249
 * @route '/admin/dashboad/manage/setting/preloader/delete/{id}'
 */
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/setting/preloader/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::recycle
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:274
 * @route '/admin/dashboad/manage/setting/preloader/recycle'
 */
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/recycle',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::bulkAction
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:308
 * @route '/admin/dashboad/manage/setting/preloader/bulk/action'
 */
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/setting/preloader/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::exportPdf
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:407
 * @route '/admin/dashboad/manage/setting/preloader/export/single/pdf/{id}/{slug}'
 */
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::export_excel
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:436
 * @route '/admin/dashboad/manage/setting/preloader/export/excel'
 */
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::export_csv
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:443
 * @route '/admin/dashboad/manage/setting/preloader/export/csv'
 */
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\backend\setting\PreloaderController::export_pdf
 * @see app/Http/Controllers/backend/setting/PreloaderController.php:421
 * @route '/admin/dashboad/manage/setting/preloader/export/pdf'
 */
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/preloader/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const PreloaderController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }
