...
/**
* @see \App\Http\Controllers\backend\setting\FaveiconController::index
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\setting\FaveiconController::insert
...
/**
* @see \App\Http\Controllers\backend\setting\FaveiconController::exportPdf
...
/**
* @see \App\Http\Controllers\backend\setting\FaveiconController::importIcon
 ...
 */
export const importIcon = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: importIcon.url(options),
    method: 'get',
})

importIcon.definition = {
    methods: ["get","head"],
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
importIcon.url = (options?: RouteQueryOptions) => {
    return importIcon.definition.url + queryParams(options)
}
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
importIcon.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: importIcon.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
importIcon.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: importIcon.url(options),
    method: 'head',
})
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
    const importIconForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: importIcon.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
        importIconForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: importIcon.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/dashboad/manage/setting/faveicon/import/all/icons'
 */
        importIconForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: importIcon.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    importIcon.form = importIconForm
const FaveiconController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, importIcon, delete: deleteMethod }

export default FaveiconController