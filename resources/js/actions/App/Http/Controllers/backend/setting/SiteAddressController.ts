...
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::index
 * @see app/Http/Controllers/backend/setting/SiteAddressController.php:23
 * @route '/admin/dashboad/manage/setting/contact/address/all'
 */
...
index.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/all',
...
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::add
 * @see app/Http/Controllers/backend/setting/SiteAddressController.php:48
 * @route '/admin/dashboad/manage/setting/contact/address/add'
 */
...
add.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/add',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    add.form = addForm
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::view
 * @see app/Http/Controllers/backend/setting/SiteAddressController.php:57
 * @route '/admin/dashboad/manage/setting/contact/address/view/{id}/{slug}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/view/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    view.form = viewForm
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::edit
 * @see app/Http/Controllers/backend/setting/SiteAddressController.php:69
 * @route '/admin/dashboad/manage/setting/contact/address/edit/{id}/{slug}'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/edit/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::insert
 * @see app/Http/Controllers/backend/setting/SiteAddressController.php:86
 * @route '/admin/dashboad/manage/setting/contact/address/submit'
 */
...
insert.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/setting/contact/address/submit',
...
update.definition = {
    methods: ["patch"],
    url: '/admin/dashboad/manage/setting/contact/address/update',
...
active.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/active/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
deactive.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/deactive/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
softdelete.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/setting/contact/address/softdelete/{id}',
...
deleteMethod.definition = {
    methods: ["delete"],
    url: '/admin/dashboad/manage/setting/contact/address/delete/{id}',
} satisfies RouteDefinition<["delete"]>
...
recycle.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/recycle',
} satisfies RouteDefinition<["get","head"]>
...
bulkAction.definition = {
    methods: ["post"],
    url: '/admin/dashboad/manage/setting/contact/address/bulk/action',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\backend\setting\SiteAddressController::exportPdf
...
exportPdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/export/single/pdf/{id}/{slug}',
} satisfies RouteDefinition<["get","head"]>
...
export_excel.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/export/excel',
} satisfies RouteDefinition<["get","head"]>
...
export_csv.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/export/csv',
} satisfies RouteDefinition<["get","head"]>
...
export_pdf.definition = {
    methods: ["get","head"],
    url: '/admin/dashboad/manage/setting/contact/address/export/pdf',
} satisfies RouteDefinition<["get","head"]>
...
const SiteAddressController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, delete: deleteMethod }

export default SiteAddressController