...
use App\Http\Controllers\backend\usermanagement\userAppointmentManage;
...
// user get appontment route start here
Route::controller(userAppointmentManage::class)->prefix('admin/dashboad/manage/user/get/appointment/')->name('user_get_appointment.')->group(function(){
    Route::get('all','index')->name('all');
    Route::get('add/{id}/{slug}','add')->name('add');
    Route::get('view/{id}/{slug}','view')->name('view');
    Route::get('edit/{id}/{slug}','edit')->name('edit');
